...
const {sendMessage,value,onChange,groupMessage,sortNames,username,receiver,setMedia,onChatClose,media}= props;
...
<ul>

   {
    ...
    <div className="image-container">
      ...
      {msg.message != "" ?(
    <div className="message-text"> {msg.message}</div>):null}
      </div>
